...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if word == ".":
            print("Goodbye! Total: " + str(points) + " points")
            break
        elif not isValidWord(word, hand, wordList):
            print("invalid word. Please try again.")
        else:
            points += getWordScore(word, n)
            print(word + "earned " + str(getWordScore(word, n)) + " points. Total: " + str(points) + " points.")
            hand = updateHand(hand, word)
            values = all(value == 0 for value in hand.values())
            if values:
    ...
    while True:
        ...
        if handtype not in "ner":
            ...
            if storedhand == "":
                ...
                print(playHand(storedhand, wordList, HAND_SIZE))
